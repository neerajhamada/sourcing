...
export default function Form () {
    ...
    return (
        ...
        <div className="modal-dialog modal-lg text-success fs-5.5  fst-sans-serif">
        <div className="modal-content mx-auto  bg-black" >
            <div className="modal-header">
            <h5 className="modal-title text-success w-100 text-center" id="exampleModalLabel">ENTER SOURCING DETAILS</h5> 
            ...
            <div className="form-check">
                    <label className="form-check-label text-success" htmlFor="Check2">I hereby declare that all the information given by me in this application is true and correct to the best of my knowledge and belief.</label>
