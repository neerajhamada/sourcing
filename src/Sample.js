...
export default function Sample () {
    ...
    return (
        <div className="me-md-5">
            ...
            <div class="modal-dialog modal-lg  fs-5.5  fst-sans-serif">
                <div class="modal-content mx-auto  bg-black">
                <div class="modal-header text-white w-100 text-center">
                ...
                <form>
                    ...
                    <div className="form-check">
                            <label className="form-check-label text-white" htmlFor="Check2">I hereby declare that all the information given by me in this application is true and correct to the best of my knowledge and belief.</label>
